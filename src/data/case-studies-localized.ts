...
const localized: Record<AppLocale, LocalizedNarrative[]> = {
  zh: [
    ...
    },
    {
      ...
      role: ["整理使用场景和页面结构", "搭建并重构 390px 移动端工作台", "接入语音、图片和文字输入", "设计候选任务的展示方式", "把页面部署到 /sheep 入口"],
      ...
      whatIBuilt: ["390px 移动端工作台", "语音和文字输入", "输入确认页", "任务卡片列表", "本地历史记录", "/sheep 同域入口"],
      reflection: "这次尝试让我意识到，语音整理的难点不只是识别准确率，还包括用户是否愿意信任整理结果。候选状态虽然多一步，但更适合处理容易出错的输入。",
      screenCaptions: ["首页：工作台和快速记录", "输入面板：粘贴或录入内容", "分析结果：整理文本和执行信息", "候选任务：选择和编辑", "任务清单：追踪确认后的事项"]
    },
    {
      projectNumber: "02",
      slug: "proddoc-ai",
  ...
  en: [
    ...
    },
    {
      ...
      accent: "violet",
      title: "Heard Sheep",
      subtitle: "Voice-to-action workspace",
      eyebrow: "VOICE TO ACTION",
      ...
      homepageOutcome: "Voice input, task extraction, a 390px mobile workspace, and a monochrome visual system.",
      ...
      role: ["Organized the use case and page structure", "Built and redesigned the 390px mobile workspace", "Added voice, image, and text input", "Designed the draft-task display", "Deployed the page under /sheep"],
      ...
      whatIBuilt: ["390px mobile workspace", "Voice and text input", "Input review", "Task cards", "Local history", "/sheep route"],
      ...
      screenCaptions: ["Home: workspace and quick capture", "Input panel: paste or enter content", "Analysis: organized text and execution details", "Draft tasks: select and edit", "Task list: track confirmed items"]
    },
    {
      projectNumber: "02",
      slug: "proddoc-ai",
      ...
      homepageProblem: "Project material often lives across forms, old files, and loose drafts.",
      ...
      problem: "Writing product documentation takes more than generating paragraphs. The slow parts are clarifying context, organizing sources, keeping structure, and revising the output.",
