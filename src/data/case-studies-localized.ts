  ...
  zh: [
    {
      ...
      homepageOutcome: "我主要尝试了语音输入、任务拆分和网页端交互呈现。",
    ...
    },
    {
      ...
      homepageOutcome: "我主要尝试了结构化提问、文档生成和页面组织。",
    ...
    },
    {
      ...
      homepageOutcome: "我主要尝试了信息整理、选项比较和辅助判断展示。",
  ...
  en: [
    {
      ...
      homepageOutcome: "I tried voice input, task extraction, and a simple web interaction for review.",
      homepageStack: ["Next.js", "TypeScript", "Xiaomi MiMo", "PWA"],
    ...
    },
    {
      ...
      homepageOutcome: "I tried structured questions, generated drafts, and a cleaner page layout for editing.",
      homepageStack: ["Next.js", "React", "shadcn/ui", "docx"],
    ...
    },
    {
      ...
      homepageOutcome: "I tried information organization, option comparison, and a clearer display for assisted decisions.",
      homepageStack: ["JavaScript", "Express.js", "Xiaomi MiMo", "Nginx"],
