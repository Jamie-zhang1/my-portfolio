...
export const projects: Project[] = [
  /* ─────────────── 01 / 听到了咩 ─────────────── */
  {
    ...
    longDescription: [
      ...
      "项目采用移动端优先设计，390px 手机容器，以白底、中性浅灰卡片、炭黑主操作和抽象“声波—行动”品牌标记构成新的单色视觉系统，支持 PWA 安装到手机桌面。当前为可运行 Web MVP，采用本地 JSON 存储，单用户模式。",
    ],
    ...
    screenshot: "/projects/heard-sheep/showcase-20260721-home.png",
    screenshotAlt: "听到了咩 — 首页录音入口",
    screenshots: [
      { src: "/projects/heard-sheep/showcase-20260721-home.png", alt: "首页", caption: "首页 — 工作台、快速记录与声波品牌标记" },
      { src: "/projects/heard-sheep/showcase-20260721-input.png", alt: "粘贴文本", caption: "输入面板 — 粘贴文本、示例内容与确认操作" },
      { src: "/projects/heard-sheep/showcase-20260721-analysis.png", alt: "AI 分析结果", caption: "AI 分析 — 整理文本、候选任务与执行方案" },
      { src: "/projects/heard-sheep/showcase-20260721-candidates.png", alt: "候选任务", caption: "候选任务 — 选择、编辑并确认加入任务清单" },
      { src: "/projects/heard-sheep/showcase-20260721-tasks.png", alt: "任务列表", caption: "任务页 — 已加入的任务分组展示" },
      { src: "/projects/heard-sheep/showcase-20260721-me.png", alt: "我的", caption: "个人中心 — PWA 安装、偏好设置与数据管理" },
    ],
    features: [
      ...
      { title: "移动端优先与 PWA", description: "390px 手机容器优先设计，白底与中性浅灰卡片、炭黑主操作、底部安全区、弹层安全区、触控目标和安装引导均围绕手机使用场景优化。" },
    ...
    homepageImages: [
      { src: "/projects/heard-sheep/showcase-20260721-home.png", alt: "首页录音入口" },
      { src: "/projects/heard-sheep/showcase-20260721-analysis.png", alt: "AI 分析结果" },
      { src: "/projects/heard-sheep/showcase-20260721-tasks.png", alt: "任务列表" },
    ],
    icon: { src: "/project-icons/heard-sheep.svg", alt: "听到了咩声波行动标记" },
  ...
  /* ─────────────── 03 / AI Decision Copilot ─────────────── */
  {
    ...
    demoUrl: null,
    screenshot: "/screenshots/portfolio/copilot-desktop.png",
    screenshotAlt: "AI Decision Copilot",
    screenshots: [
      { src: "/screenshots/portfolio/copilot-demo-select.png", alt: "AI Decision Copilot input", caption: "问题与选项输入" },
      { src: "/screenshots/portfolio/copilot-demo-result.png", alt: "AI Decision Copilot result", caption: "比较、推荐与风险结果" },
    ],
    features: [
    ...
    homepageImages: [
      { src: "/screenshots/portfolio/copilot-demo-select.png", alt: "AI Decision Copilot input" },
      { src: "/screenshots/portfolio/copilot-demo-result.png", alt: "AI Decision Copilot result" },
    ],
  ...
  /* ─────────────── 04 / ResearchFlow Agent ─────────────── */
  {
    ...
    screenshot: "/projects/researchflow-agent/workspace.png",
    screenshotAlt: "ResearchFlow Agent workflow prototype",
    screenshots: [
      { src: "/projects/researchflow-agent/workspace.png", alt: "ResearchFlow Agent live workspace", caption: "线上工作台 — 项目、资料、证据与大纲入口" },
    ],
    features: [
    ...
    homepageImages: [
      { src: "/projects/researchflow-agent/workspace.png", alt: "ResearchFlow Agent live workspace" },
    ],
