...
const paths = [
  ...
  { pathname: "/notes/idea/new", priority: 0.7 },
  { pathname: "/notes/draft/new", priority: 0.7 },
  { pathname: "/notes/review/new", priority: 0.7 },
  { pathname: "/notes/learning/new", priority: 0.7 },
